# SqliteDbProvider\.GetProductDetails\(String\) Method
...
```csharp
public System.Data.DataSet GetProductDetails(string productCode)
```
...
* [IDbProvider.GetProductDetails](../../IDbProvider/GetProductDetails/README.md)
